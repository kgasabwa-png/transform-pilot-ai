  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Thanks for waiting. Nyvlo is now open — it captures meetings without a bot, enhances your
          rough notes, and turns conversations into follow-ups and memory.
        </Text>
        <Text style={text}>
          As an early supporter, here's <strong>50% off your first 3 months</strong> of Nyvlo Pro.
        ...
        <Text style={small}>
          Free tier is also live (10 captures a month, no card needed) if you want to kick the tires
          first.
        </Text>
