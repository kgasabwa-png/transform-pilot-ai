    ...
    <div className="grid min-h-dvh bg-background md:grid-cols-2">
      <div className="hidden flex-col justify-between border-r border-border bg-secondary p-12 md:flex">
        ...
        <div className="max-w-md space-y-6">
          <h2 className="text-3xl font-semibold tracking-tight">The AI notepad for meetings.</h2>
          <p className="text-sm text-muted-foreground">
            Capture conversations without inviting a bot, jot what matters, and leave with enhanced
            notes, actions, and searchable memory.
          </p>
