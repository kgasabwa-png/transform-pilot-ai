  ...
  head: () => ({
    meta: [
      ...
      { title: "Nyvlo · The private AI notepad for meetings" },
      {
        name: "description",
        content:
          "Nyvlo captures conversations without a bot, enhances your rough notes, and turns meetings into actions and searchable memory.",
      },
      ...
      { property: "og:title", content: "Nyvlo · The private AI notepad for meetings" },
      {
        ...
        content:
          "Capture conversations without a bot, enhance rough notes, and leave with actions and searchable memory.",
      },
    ...
    links: [
      { rel: "stylesheet", href: appCss },
      {
        rel: "icon",
        type: "image/png",
        href: "/__l5e/assets-v1/6211f021-75b1-484a-8d96-f59fda81e71b/nyvlo-logo-transparent.png",
      },
      {
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700;800;900&family=Manrope:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap",
      },
    ],
  }),
