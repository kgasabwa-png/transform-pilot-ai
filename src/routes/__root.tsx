...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Nyvlo captures conversations without a bot, enhances your rough notes, and turns meetings into actions and searchable memory." },
      { name: "theme-color", content: "#0b0c10" },
      { property: "og:title", content: "Nyvlo · The private AI notepad for meetings" },
      { property: "og:description", content: "Capture conversations without a bot, enhance rough notes, and leave with actions and searchable memory." },
      ...
      { name: "twitter:title", content: "Nyvlo · The private AI notepad for meetings" },
      { name: "twitter:description", content: "Capture conversations without a bot, enhance rough notes, and leave with actions and searchable memory." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Geist:wght@400;500;600;700;800;900&family=Manrope:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap" },
    ],
  }),
