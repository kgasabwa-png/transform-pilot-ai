      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        ...
        <div className="prose prose-neutral mt-10 max-w-none text-[15px] leading-relaxed">
          ...
          <ul className="mt-3 space-y-1.5">
            ...
            <li>
              Connections: read-only access to your Google Calendar and Gmail metadata only when you
              connect them.
            </li>
            <li>
              Captures: meeting audio, screen frames, and text snippets that <em>you</em> start a
              capture session for, via the desktop app, browser recorder, or Chrome extension.
            </li>
            <li>
              Product analytics: page views, button clicks, and feature usage to improve the
              product.
            </li>
          </ul>
          ...
          <ul className="mt-3 space-y-1.5">
            <li>
              No silent or background screen / audio capture. Capture only runs while a session is
              active and the indicator is visible.
            </li>
          ...
          <p className="mt-3">
            ...
            short-lived audio chunk is retained only as long as needed to produce the transcript and
            create enhanced notes and action items. Screen frames are processed for OCR + a vision
            summary, then the raw image is similarly short-lived. The structured outputs
            (transcript, summary, enhanced notes, and action items) are stored in your account and
            visible only to you.
          </p>
          ...
          <ul className="mt-3 space-y-1.5">
            ...
            <li>
              Email{" "}
              <a href="mailto:keila@nyvloai.com" className="underline">
                keila@nyvloai.com
              </a>{" "}
          ...
          <p className="mt-3">
            ...
            our primary database within 24 hours and from backups within 30 days. Anonymized usage
            analytics may be retained longer.
          </p>
          ...
          <p className="mt-3">
            ...
            In two-party-consent regions (e.g. California, most of the EU), inform everyone in the
            meeting before starting a capture session.
          </p>
