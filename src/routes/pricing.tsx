  ...
  head: () => ({
    meta: [
      { title: "Pricing · Nyvlo — Free, then $18/mo for unlimited" },
      {
        name: "description",
        content:
          "Free forever for 10 captures a month. Pro is $18/mo or $144/yr ($12/mo) for unlimited capture, desktop app, and unlimited memory.",
      },
    ],
  }),
  component: Pricing,
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-border bg-card/60 p-7">
            ...
            <p className="mt-1 text-[13.5px] text-muted-foreground">
              Try Nyvlo and use it for light weeks.
            </p>
            ...
            <ul className="mt-6 space-y-2.5">
              {[
                "10 meetings / month, 30 min each",
                "Browser recorder (mic)",
                "Enhanced notes and action items",
                "7-day notes history",
            ...
            <Link
              to="/auth"
              className="mt-7 inline-flex w-full items-center justify-center rounded-md border border-border bg-background px-4 py-2.5 text-[14px] font-medium hover:bg-muted"
            >
              Get started
            </Link>
          </div>
          ...
          <div className="rounded-2xl border border-primary/40 bg-card p-7 shadow-[0_30px_80px_-30px_rgba(15,15,30,0.18)]">
            ...
            <p className="mt-1 text-[13.5px] text-muted-foreground">
              For founders, operators, and anyone with a packed week.
            </p>
            <div className="mt-5 flex items-baseline gap-1.5">
